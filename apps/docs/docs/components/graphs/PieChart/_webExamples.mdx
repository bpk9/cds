...
<VStack alignItems="center" gap={2}>
  ...
  />
  <Text font="label2" color="fgMuted">Risk Distribution</Text>
</VStack>
```
      ...
      <VStack gap={2}>
        {series.map((item) => (
          <HStack key={item.id} gap={2} alignItems="center">
            ...
            />
            <Text font="label1" style={{ minWidth: 80 }}>{item.label}</Text>
      ...
      <Box position="relative" width={200} height={120}>
        ...
        >
          <VStack alignItems="center">
            ...
            <Text font="label2" color="fgMuted">Goal Progress</Text>
          </VStack>
        </Box>
      </Box>
    </VStack>
...
<HStack gap={4}>
  <HStack gap={2} alignItems="center">
    ...
    <VStack gap={0}>
      ...
      <Text font="label2" color="fgMuted">Allocation</Text>
    </VStack>
  </HStack>
  <HStack gap={2} alignItems="center">
    <PieChart
    ...
    <VStack gap={0}>
      ...
      <Text font="label2" color="fgMuted">Split</Text>
    </VStack>
  </HStack>
</HStack>
```
