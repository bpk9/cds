...
To render horizontal bars, set the `layout` prop to `"vertical"`. In this layout, the Y axis becomes the categorical axis and the X axis becomes the value axis.
