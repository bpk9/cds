...
>
  <XAxis position="end" showLine showTickMarks showGrid />
...
`linear` and `log` are numeric scales while `band` is a categorical scale. `band` is most commonly used for bar charts.
...
>
  <XAxis position="end" showLine showTickMarks showGrid tickInterval={16} />
  <Line seriesId="prices" curve="monotone" showArea />
</CartesianChart>
```
...
function XAxisGridExample() {
  ...
  return (
    <VStack gap={2}>
      ...
      >
        <XAxis position="end" showLine showTickMarks showGrid={showGrid} />
        <Line seriesId="prices" curve="monotone" showArea />
        <Scrubber />
      </CartesianChart>
    </VStack>
...
function CustomGridLineExample() {
  ...
  return (
    ...
    >
      <XAxis position="end" showLine showTickMarks showGrid GridLineComponent={ThinSolidLine} />
      <Line seriesId="prices" curve="monotone" showArea />
      <Scrubber />
    </CartesianChart>
  );
...
function XAxisLineExample() {
  ...
  return (
    <VStack gap={2}>
      ...
      >
        <XAxis position="end" showLine={showLine} showTickMarks showGrid />
        <Line seriesId="prices" curve="monotone" showArea />
        <Scrubber />
      </CartesianChart>
    </VStack>
...
>
  <XAxis position="end" showLine showTickMarks showGrid size={64} />
  <Line seriesId="prices" curve="monotone" showArea />
  <Scrubber />
</CartesianChart>
```
...
>
  <XAxis position="end" showLine showTickMarks showGrid ticks={[0, 2, 4, 6]} />
  <Line seriesId="prices" curve="monotone" showArea />
  <Scrubber />
</CartesianChart>
```
...
>
  <XAxis position="end" showLine showTickMarks showGrid requestedTickCount={4} />
  <Line seriesId="prices" curve="monotone" showArea />
  <Scrubber />
</CartesianChart>
```

`tickInterval`, which accepts pixels, will measure the available space and try to create evenly spaced ticks. It will always include the first and last values of the domain.
...
You can show tick marks on the axis using the `showTickMarks` prop. You can also customize the tick mark size using the `tickMarkSize` prop, which accepts pixels.
...
function XAxisTickMarksExample() {
  ...
  return (
    <VStack gap={2}>
      ...
      >
        <XAxis position="end" showLine showTickMarks={showTickMarks} tickMarkSize={16} showGrid />
        <Line seriesId="prices" curve="monotone" showArea />
        <Scrubber />
      </CartesianChart>
    </VStack>
...
>
  <XAxis position="end" showGrid tickLabelFormatter={(value) => `Day of ${value}`} />
  <Line seriesId="prices" curve="monotone" showArea />
  <Scrubber />
</CartesianChart>
```
...
>
  <XAxis position="end" showGrid tickLabelFormatter={(value) => value * 2} />
  <Line seriesId="prices" curve="monotone" showArea />
  <Scrubber />
</CartesianChart>
```
