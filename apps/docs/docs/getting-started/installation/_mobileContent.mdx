...
```bash
npm install react-native-reanimated@^3 react-native-screens@^3 react-native-linear-gradient@^2 @react-navigation/native@^6 @react-navigation/native-stack@^6 @react-navigation/stack@^6
```

Or with Yarn:

```bash
yarn add react-native-reanimated@^3 react-native-screens@^3 react-native-linear-gradient@^2 @react-navigation/native@^6 @react-navigation/native-stack@^6 @react-navigation/stack@^6
```
